...
class Zend_Config implements Countable, Iterator
{
    ...
    /**
     * Retrieve an attribute value and return $default if there is no attribute set.
     *
     * @param string $name
     * @param mixed $default
     * @return mixed
    ...
    public function getAttribute($name, $default = null)
    {
        ...
        if (array_key_exists('@attributes', $this->_data)) {
          $result = $this->_data['@attributes']->get($name, $result);
        }
        return $result;
    }
    
    /**
     * Get first matching config node for given attribute name and value 
     * 
     * @param string $name The name of the attribute
     * @param string $value The value of the attribute
     * @return mixed
     */
    public function getWhereAttribute($name, $value)
    {
        if(is_array($this->_data) && !array_key_exists('@attributes',$this->_data)) {
